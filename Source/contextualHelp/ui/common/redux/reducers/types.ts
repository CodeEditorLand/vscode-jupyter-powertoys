...
import { IEditorContentChange, WindowMessages } from "../../../../messages";
import { CursorPos, IMainState } from "../../types";
import { ActionWithPayload, ReducerArg } from "../reduxUtils";
...
export type CommonActionTypeMapping = {
	...
	[CommonActionType.INSERT_BELOW_AND_FOCUS_NEW_CELL]: ICellAction &
		IAddCellAction;
	[CommonActionType.INSERT_ABOVE_AND_FOCUS_NEW_CELL]: ICellAction &
		IAddCellAction;
...
export type CommonReducerArg<
	AT = CommonActionType | WindowMessages,
	T = never | undefined,
> = ReducerArg<IMainState, AT, BaseReduxActionPayload<T>>;
...
export type CommonAction<T = never | undefined> = ActionWithPayload<
	T,
