...
export namespace Constants {
	export const OpenScratchPadInteractive =
		"jupyter.notebookeditor.openInInteractive";

	export const OpenContextualHelp =
		"jupyter.notebookeditor.openContextualHelp";
}
